...
public class JazzBassPattern02 extends Pattern implements JMC{
	...
	public Measure buildMeasure(Chord[] chord){
		...
		case 1:
			if(chord[0].getBass_note() > 0){
				...
				phrase[0].add(new Note(chord[0].getBass_note() + 7 - 12, 5*EIGHTH_NOTE_TRIPLET));
				phrase[0].add(new Note(REST, EIGHTH_NOTE_TRIPLET));
			}else{
				phrase[0].add(new Note(chord[0].getRoot_note(), 5*EIGHTH_NOTE_TRIPLET));
				phrase[0].add(new Note(REST, EIGHTH_NOTE_TRIPLET));
				phrase[0].add(new Note(chord[0].getFifth_note() - 12, 5*EIGHTH_NOTE_TRIPLET));
				phrase[0].add(new Note(REST, EIGHTH_NOTE_TRIPLET));
			}
