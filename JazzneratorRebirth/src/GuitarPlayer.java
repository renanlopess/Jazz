...
public class GuitarPlayer extends Instrumentalist implements JMC, MusicTheory{
	
	GuitarPlayer(SongRepresentation song, Pattern pattern[]){
		setPattern(pattern);
	...
	private Part buildPart(Key key, PartRepresentation partRepresentation){
		// Create part with nylon guitar sound(24) that plays on channel one(1);
		Part part1 = new Part(24,1);
